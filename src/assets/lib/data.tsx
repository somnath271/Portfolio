...
export const projectsData = [
  {
    ...
    description_EN:
      "A dynamic weather app that provides real-time weather updates using the OpenWeatherMap API. I handled the front-end and back-end development, including features like location search and temperature unit toggle. The app is responsive and optimized for both desktop and mobile devices",
    technologies: [
    ...
    image: weatherApp,
    deploymenturl: "https://my-weather-app-xjyn.onrender.com/",
    githuburl: "https://github.com/somnath271/My_Weather_App",
    githubicon: FiGithub,
  ...
  },
  {
    ...
    description_EN:
      "A web app designed to help users calculate the best times to wake up and go to sleep based on sleep cycles. I developed the front-end, focusing on a user-friendly interface and interactive time selection. The app ensures an optimal sleep schedule with a clean, responsive design for all devices.",
    technologies: [
      { name: "Html", icon: htmlicon },
      { name: "CSS", icon: cssicon },
      { name: "JavaScript", icon: javascripticon },
  ...
  },
  {
    ...
    description_EN:
      "A web app that provides personalized clothing recommendations based on occasion and season. I developed the front-end using React, focusing on a smooth user experience and interactive recommendation filters. The app is fully responsive, ensuring seamless use on both mobile and desktop devices.",
    technologies: [
      { name: "Html", icon: htmlicon },
      { name: "CSS", icon: cssicon },
      { name: "JavaScript", icon: javascripticon },
    ...
    image: clothesRecommendation,
    deploymenturl: "https://github.com/somnath271/Stylish-Clothes-Recommendation-System",
    githuburl: "https://github.com/somnath271/Stylish-Clothes-Recommendation-System",
    githubicon: FiGithub,
    deploymenticon: FiLink,
    colors: {
      main: "main-btn",
...
export const sideBarRightMail = {
  link: "mailto:sumanbhattarai200@gmail.com",
  text: "sumanbhattarai200@gmail.com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/somnath-bhattarai/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/somnath271",
    icon: FiGithub,
    altimgname: "github",
  },
  {
...
export const contactData = {
  ...
  privacyOptIn: {
    checkbox: {
      de: "Ich stimme zu, dass Somnath meine personenbezogenen Daten (Name und E-Mail-Adresse) verwenden darf, um mit mir Kontakt aufzunehmen.",
      en: "I agree that Somnath may use my personal data (name and e-mail address) to contact me.",
    },
    description: {
